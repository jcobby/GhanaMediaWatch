 ...
 *
 * This screen is where the product's loop closes. A business licenses a report
 ...
 * business's decision, not an automatic consequence of buying it.
 *
...
export function PublishedScreen() {
  ...
  const release = (incident: Incident) => {
    ...
    toast.success(
      ...
      t('published.releasedBody', { name: business.name }),
    );
  };
                  ...
                  <View className="gap-2 border-t border-hairline/[0.07] pt-3">
                    <View className="flex-row items-center gap-2">
                      ...
                      <Text variant="caption" tone="muted" className="flex-1">
                        {t('published.creditedTo', { name: business.name })}
                      </Text>
                    </View>
                    <Button
